...
dfh <- read.csv(unzip(temph, "ss16hia.csv", exdir = "./Part1A"))
dfp <- read.csv(unzip(tempp, "ss16pia.csv", exdir = "./Part1A"))
#Remove unnecessary objects
rm(urlh, urlp, temph, tempp)
###Just Read in already downloaded files
#dfh <- read.csv("./Part1A/ss16hia.csv")
#dfp <- read.csv("./Part1A/ss16pia.csv")
...
dfPUMA <- read.csv("./Part1A/dfPUMA.csv", row.names = 1)
...
#<<<<<<< HEAD
#dfh <- dfh[,c("SERIALNO", "PUMA", "ADJHSG", "ADJINC", "WGTP", "NP", "TYPE", "AGS", "BLD", "TEN", "VACS", "VALP", "FES", "FINCP", "HINCP", "HUPAC", "OCPIP", "WIF")]
#=======
...
###Clean up dfp
#Remove unnecessary columns
dfp <- dfp[,c("SERIALNO", "PUMA", "ADJINC", "PWGTP", "AGEP", "COW", "DDRS", "DEAR", "DEYE", "DOUT", "DPHY", "DRATX", "DREM", "FER", "HINS1", "HINS2", "HINS3", "HINS4", "HINS5", "HINS6", "HINS7", "INTP", "OIP", "PAP", "RETP", "SEMP", "SEX", "SSIP", "SSP", "WAGP", "DIS", "ESR", "HICOV", "OCCP", "PERNP", "PINCP", "PRIVCOV", "PUBCOV")]
#=======
#>>>>>>> b5c3c66b1500f006cf09f6e094a1ebeb7a1e7aa0
#Change column types
...
write.csv(dfh, "./Part1A/cleanedhia.csv", row.names = F)
write.csv(dfp, "./Part1A/cleanedpia.csv", row.names = F)
